/* ============================================================
   HAPPY BIRTHDAY TO YOU— a birthday film in four acts
...
// 🔗 Connect Next button to main Birthday-Gift project

const nextButton = document.getElementById("replay");

if (nextButton) {
    nextButton.addEventListener("click", function () {
        window.parent.postMessage("interactiveGiftNext", "*");
    });
}